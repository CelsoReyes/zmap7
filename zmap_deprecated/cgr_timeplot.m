...
function CreateMenu(obj)
        ...
        uimenu (analyzemenu,'Label','Decluster the catalog','MenuSelectedFcn',@(~,~)ResenbergDeclusterClass(mycat))
        ...
        %initial time.
        uimenu(op5,'Label','p as a function of time and magnitude','MenuSelectedFcn', @(~,~)MyPvalClass.pvalcat2())
