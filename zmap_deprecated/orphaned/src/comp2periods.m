...
if sel == 'in'
    ...
    labelList2=[' z-values | beta values | probability (based on z) |  probability (based on beta) | percent '];
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback',' inb1 =get(hndl2,''Value'');tgl1 =get(tgl1,''Value'');tgl2 =get(tgl2,''Value'');prev_grid = get(prev_grid,''Value'');create_grid = get(create_grid,''Value''); load_grid = get(load_grid,''Value''); save_grid = get(save_grid,''Value''); close,sel =''ca'',comp2periods',...
        'String','Go');
...
if sel == 'ca'
    ...
    drawnow
    %
    bvg = zeros(length(newgri(:,1)),3)*nan;
