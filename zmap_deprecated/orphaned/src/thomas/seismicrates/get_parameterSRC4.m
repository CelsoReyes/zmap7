function [params, vDeclus]=get_parameterSRC4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
disp('~/zmap/src/thomas/seismicrates/get_parameterSRC4');

params.sFile='08081408-M16-Reasen.mat'; %ilename for result matrix
% params.sFile='08041401-Nodeclus.mat'; %ilename for result matrix

% load catalog and independence probability
% vDeclus=load('~/zmap/results/PreDecluster/Landers/Mc20New/mDeclus08072501.mat');
vDeclus=load('mDeclus08072503.mat');
...
% params.sFilename='anss-1975-19923-M15-Wiemer1994plus50km.mat';
params.sFilename='anss-1975-19923-M15-Wiemer1994.mat';
% params.sFilename='anss-1981-19923-M15-Wiemer1994.mat';
% params.sFilename='~/zmap/eq_data/lsh_1.12/lsh1.12WiemerWyss1994.mat';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
params.nSynCat=0;       % 0: Real Catalog (no synsthetic catalog calculated
...
% params.vTw=[4]';
params.vTw = [4 ]';
params.vRegion=[-118.2, -114.5, 32.1, 36.1];
...
params.nMinimumNumber=50;        % Minimum Number of events if working with
                                 % constant radius
params.fRadius=10;               % Radius (if working with constant radius
