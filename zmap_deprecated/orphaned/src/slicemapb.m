...
global newt2  hndl2 tgl1 Rconst
...
switch(slm)
    ...
    case 'new'
        ...
        for j = 1:length(gz)
            ...
            for i = 1:length(l)
                ...
                me1= mean(s1_east);
                me2= mean(s2_west);
                zvg(l(i),l2(i),j) = -(me1 - me2)/(sqrt(var1/(length(s1_east))+var2/length(s2_west)));
            end % for i
        end % for j
    ...
    case 'statsq'
        ...
        for i = 1:500
            ...
            me1= mean(s1_east);
            me2= mean(s2_west);
            as(i) = (me1 - me2)/(sqrt(var1/(length(s1_east))+var2/length(s2_west)));
        end % for i
