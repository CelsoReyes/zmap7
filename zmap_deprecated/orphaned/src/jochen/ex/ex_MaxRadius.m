function [mMaxRadCatalog] = ex_MaxRadius(mCatalog, mPolygon, nNode, caNodeIndices, fMaxRadius, nNumberEvents, bMap)
% function [mMaxRadCatalog] = ex_MaxRadius(mCatalog, mPolygon, nNode, caNodeIndices, fMaxRadius, nNumberEvents, bMap);
% --------------------------------------------------------------------------------------------------------------------
% Function to calculate an earthquake catalog for one grid node on a given number and a maximum radius.
...
% Create node catalog
mNodeCatalog_ = mCatalog(caNodeIndices{nNode}, :);
