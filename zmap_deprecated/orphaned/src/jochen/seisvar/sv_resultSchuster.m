...
try
  ...
  %plot(handles.vResult.vCoastline(:,1), handles.vResult.vCoastline(:,2),'LineWidth',1.0,'Color',[0  0  0 ]);
  %plot(handles.vResult.vFaults(:,1), handles.vResult.vFaults(:,2),'k','LineWidth',0.2);
...
% --------------------------------------------------------------------
function Ztools_menu_Callback(h, eventdata, handles)
% hObject    handle to Ztools_menu (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function menu_Ztools_FMD_Callback(h, eventdata, handles)
% hObject    handle to menu_Ztools_FMD (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
nargin =1;
vResults = handles.vResults;
hParentFigure = handles.dlgResult;
aux_1FMDb(vResults,hParentFigure);
