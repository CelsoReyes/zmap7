...
bmap = figure_w_normalized_uicontrolunits( ...
    ...
    'backingstore','on',...
    'Visible','off', ...
    'Position',[ (fipo(3:4) - [600 400]) winx winx]);
% make menu bar
matdraw
...
l=storedcat.Depth <=3.0 & storedcat.Depth > 1.5 ;
a=storedcat.subset(l);
...
l=storedcat.Depth <=6.0 & storedcat.Depth > 3.0 ;
a=storedcat.subset(l);
