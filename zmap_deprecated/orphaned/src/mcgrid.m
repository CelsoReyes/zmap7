...
if sel == 'in'
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1 =get(hndl1,''Value'');inb2 =get(hndl2,''Value'');close,sel =''ca'', mcgrid',...
        'String','Go');
...
if sel == 'ca'
    ...
    for i= 1:length(newgri(:,1))
        ...
        % call the Mc -value function
        maxmag = max(b(:,6));
        mima = min(b(:,6));
        [bval,xt2] = hist(b(:,6),(mima-0.05:0.1:maxmag+0.05));
        j = find(bval == max(bval));
        magco = min(xt2(j))+0.05;
        bvg = [bvg ; magco magco x y l2(ni) ];
