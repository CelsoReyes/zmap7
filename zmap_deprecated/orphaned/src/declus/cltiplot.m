function cltiplot(var1)
    ...
    error('How did you reach this file?')
...
function cllta(var1)
    ...
    freq_field=uicontrol('Style','edit', 'Units','normalized','Position',[.40 .00 .12 .06],...
        'String',num2str(years(ZG.compare_window_dur_v3)),...
        'callback',@cb_compwindir_v3);
    
    freq_slider=uicontrol('BackGroundColor',[ 0.8 0.8 0.8],'Style','slider',...
        'Units','normalized', 'Position',[.30 .10 .45 .06],...
        'Value',years(ZG.compare_window_dur_v3),...
        'Max',max_freq, 'Min',min_freq,...
        'callback',@cb_freqchanged);
    
    close_button=uicontrol('Style','Pushbutton','Units','normalized', 'Position',[.9 .30 .10 .05],...
        'callback',@cb_close,'String','Close');
    
    %uicontrol('Units','normal','Position',[.9 .80 .10 .05],'String','Save', 'callback',@cb_save)
    ...
    function cb_compwindir_v3(mysrc,myevt)
    ...
    function cb_freqchanged(mysrc,myevt)
...
function cltipval(var1)
    ...
    if var1==1 | var1==2              %magnitude or time estimate
        ...
        Info_p = uicontrol('Style','Pushbutton',...
            'String','Info ',...
            'Position',[.3 .05 .10 .06],...
            'Units','normalized','callback',@(~,~)clinfo("inpPvalMag"));
        if var1==2
            set(Info_p, 'callback',@(~,~)clinfo("inpPvalTime"));
        end
        close_p =uicontrol('Style','Pushbutton',...
            'Position', [.45 .05 .10 .06 ],...
            'Units','normalized','callback',@cb_close,...
            'String','Close');
