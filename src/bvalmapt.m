function bvalmapt(sel) % autogenerated function wrapper
    ...
    [t0b, teb] = ZG.primeCatalog.DateRange() ;
        ...
        %
        % overall b-value
        [bv, magco, stan, av,  pr] =  bvalca3(a,ZG.inb1);
        ...
        for i= 1:length(newgri(:,1))
            ...
            if b.Count >= 2*minnu
                ...
                if  sum(lt) >= minnu
                    [bv, magco1, stan, av,  pr1] =  bvalca3(b.subset(lt),ZG.inb1);
                    ZG.bo1 = bv; no1 = length(b(lt,1));
                    P6b = 10^(av-bv*6.5)/(t2-t1); %%
                    
                else
                    [bv, magco1, stan, av0,  pr1] =  bvalca3(b,ZG.inb1);
                ...
                if  sum(lt) >= minnu
                    [bv2, magco2, stan, av,  pr] =  bvalca3(b.subset(lt),ZG.inb1);
                    
                    P6a = 10^(av-bv2*6.5)/(t4-t3);
                    
                    
                else
                    [bv2 magco2 stan av0 pr] =  bvalca3(b,ZG.inb1);
