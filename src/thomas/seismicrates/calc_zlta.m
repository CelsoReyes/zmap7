function [mLTA, mProb] =calc_zlta2(mCat0,mCat1,mCat2,fTstart,fT,fTw,nTbin,nN)
    % This function calculates the rate changes (z-value) of earthquake  occurrence between two periods.
    %
