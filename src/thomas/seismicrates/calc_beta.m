function [mBeta, mProb] =calc_beta4(mCat,fTstart,fT,fTw,nTbin,nN)
    % This function calculates the rate changes (beta-value) of earthquake occurrence between two periods.
    %
    % Example:[mBeta,% mBetaprob]=calc_beta(mCat,mCat00,mCat20,params.fTstart,fT,fTw,nTbin, nN);
    %
