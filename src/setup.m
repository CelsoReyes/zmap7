...
if newMapWindowFlag
    ...
    uicontrol('BackGroundColor',[0.8 0.8 0.8]','Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','faults  = []; update(mainmap());',...
        'String','Clear ');
    ...
    uicontrol('BackGroundColor',[0.8 0.8 0.8]','Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','mainfault  = []; update(mainmap());',...
        'String','Clear ');
    ...
    uicontrol('BackGroundColor',[0.8 0.8 0.8]','Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','coastline  = []; update(mainmap());',...
        'String','Clear ');
    ...
    calSave4 =...
        ...
        'eval(sapa) ; close(loda);update(mainmap());done'];
