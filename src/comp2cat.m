function comp2cat() % autogenerated function wrapper
    ...
    function compare()
        ...
        def = {num2str(dlmax),num2str(minutes(timax))};
        ...
        if ~isempty(ni2)
            dimax = str2double(ni2{1});
            timax = minutes(str2double(ni2{2}));
        end
        id = [];
    ...
    function plot_results(f1_idx, f2_idx)
        ...
        for n = 1:numel(Times)
            ...
            warning('is this supposed to be depth? we''re mostly dealing with time...'); %TOFIX maybe
