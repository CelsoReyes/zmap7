...
if sel == 'i1'
    ...
    freq_field0=uicontrol('Style','edit',...
        ...
        'Callback','R=str2double(freq_field0.String); freq_field0.String=num2str(R); tgl2.Value=1; tgl1.Value=0;');
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1=hndl2.Value;tgl1=tgl1.Value;tgl2=tgl2.Value;close,sel =''in'', bgrid3dB',...
        'String','Go');
