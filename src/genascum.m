...
uicontrol('Units','normal','Position',...
    [.1 .10 .2 .12],'String','meanZ at time', 'callback',@callbackfun_001)

uicontrol('Units','normal','Position',...
    [.4 .10 .2 .12],'String','minZmap', 'callback',@callbackfun_002)

uicontrol('Units','normal','Position',...
    [.7 .10 .2 .12],'String','maxZmap', 'callback',@callbackfun_003)
