...
if sel == 'in'
    ...
    freq_field1=uicontrol('Style','edit',...
        ...
        'Callback','Nmin=str2double(freq_field1.String);freq_field1.String=num2str(Nmin);');
    ...
    freq_field4=uicontrol('Style','edit',...
        ...
        'Callback','fMaxRad=str2double(freq_field1.String);freq_field1.String=num2str(fMaxRad);');

    freq_field5=uicontrol('Style','edit',...
        'Position',[.30 .28 .10 .08],...
        'Units','normalized','String',num2str(fStrike),...
        'Callback','fStrike=str2double(freq_field3.String); freq_field3.String=num2str(fStrike);');
    ...
    tgl1 = uicontrol('BackGroundColor', [0.8 0.8 0.8],'Style','checkbox',...
        ...
        'Position',[.04 .58 .2 .08], 'Callback','tgl2.Value=0;',...
        'Units','normalized','FontSize',ZmapGlobal.Data.fontsz.s,'FontWeight','bold');
    ...
    tgl2 =  uicontrol('BackGroundColor', [0.8 0.8 0.8],'Style','checkbox',...
        ...
        'Position',[.5 .58 .22 .08], 'Callback','tgl1.Value=0;',...
        'Units','normalized','FontSize',ZmapGlobal.Data.fontsz.s,'FontWeight','bold');
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1=hndl2.Value;tgl1=tgl1.Value;tgl2=tgl2.Value;bGridEntireArea = get(chkGridEntireArea, ''Value''); save_grid=save_grid.Value;load_grid=load_grid.Value;close,sel =''ca'', cross_stress',...
        'String','Go');
