...
% function [fAValue] = calc_MaxLikelihoodACombined(mCatalog, mControl, fBValue, bReBin)
% -------------------------------------------------------------------------------------
% Computes the maximum likelihood a-values for a combined catalog containing different
%   periods while using a fixed b-value
%
% Input parameters:
...
[fAValue, vDummy, bExitFlag_] = fminsearch('callback_LogLikelihoodACombined', vStartValue, [], caCatalogs_, mControl, fBValue);
