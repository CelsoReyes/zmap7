function [fProbability] = callback_LogLikelihoodABCombined(vValues, caCatalogs, mControl)
    % Negative log-likelihood sum of a given a- and b-value for a combined catalog containing different periods
    %
    % [fProbability] = callback_LogLikelihoodABCombined(vValues, caCatalogs, mControl)
    %
