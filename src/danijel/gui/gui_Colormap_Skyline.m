...
nSteps = floor(nSize * 0.056);
mColormap = [mColormap; gui_Interpolate([0 0 0], [0.054902, 0.033334, 0.284313], nSteps)];

nSteps = floor(nSize * 0.342);
mColormap = [mColormap; gui_Interpolate([0.054902, 0.033334, 0.284313], [0.109804, 0.066667, 0.568627], nSteps)];
