function [fAverageBValue, fAverageStdDev] = calc_RandomBValue(mCatalog, nSampleSize, nNumberRuns)
    % Determines an average b-value and standard deviation drawing nNumberRuns random samples of size nSampleSize
    %
    % [fAverageBValue, fAverageStdDev] = calc_RandomBValue(mCatalog, nSampleSize, nNumberRuns)
    %
    %
    % Input parameters:
