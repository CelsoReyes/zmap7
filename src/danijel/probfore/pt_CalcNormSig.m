function [fSignificanceLevel, fSigmaDistance, fMu, fSigma] = pt_CalcNormSig(mValues, fTestValue)
% function [fSignificanceLevel, fMu, fSigma] = pt_CalcNormSig(mValues, fTestValue)
% --------------------------------------------------------------------------------
...
fSigmaDistance = (fTestValue - fMu)/fSigma;
