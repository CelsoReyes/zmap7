...
global  n cua b1 n1 b2 n2  ew si b;
global selt magco bv;
global hndl2 inpr1;
ZG=ZmapGlobal.Data;
think
...
if selt == 'in'
    ...
    field1 = uicontrol('Style','edit',...
        ...
        'Callback','nBstSample=str2double(field1.String); field1.String=num2str(nBstSample);');

    field2 =uicontrol('Style','edit',...
        'Position',[.65 .45 .12 .1],...
        'Units','normalized','String',num2str(fMccorr),...
        'Callback','fMccorr=str2double(field2.String); field2.String=num2str(fMccorr); hndl2.Value=1;');
    ...
    bBst_button = uicontrol('Style','checkbox',...
        ...
        'Position',[.05 .55 .4 .10],...
        'Units','normalized'); % 'Callback','wls_button.Value=0;'
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback',' inpr1=hndl2.Value;bBst_button=bBst_button.Value;close;selt =''ca''; bdiff2',...
...
if selt == 'ca'
    ...
    if existFlag
        ...
        uimenu(options,'Label','Plot time series', 'Callback','ZG.newcat = ZG.newt2; timeplot(ZG.newt2)');
