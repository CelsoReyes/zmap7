function bdiff2() % autogenerated function wrapper
    ...
    function create_my_menu()
        ...
        uimenu(options,'Label','Estimate recurrence time/probability', 'callback',@callbackfun_007);
        uimenu(options,'Label','Manual fit of b-value', 'callback',@callbackfun_008);
        uimenu(options,'Label','Plot time series', 'callback',@callbackfun_009);
        uimenu(options,'Label','Do not show discrete curve', 'callback',@callbackfun_010);
