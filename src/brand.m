function brand() % autogenerated function wrapper
    ...
    [~,~,n1,ns,n2,nr]=smart_dlg('Random b-value calculation', sdlg);
    ...
    for ni = n1:ns:n2
        ...
        for i = 1:nr
            ...
            %[bv magco stan,  av] =  bvalca3(newa(l,:),2);
            %br = [br bv];
            %ar = [ar av];
            [bv2 stan av2 ] =  bmemag(ZG.primeCatalog.subset(l));
            brm = [brm bv2];
            arm = [arm av2];
        end
        %br2 = [br2 ; br];
