...
freq_field2=uicontrol('Style','edit',...
    ...
    'Callback','minval=str2double(get(freq_field2,''String'')); set(freq_field2,''String'',num2str(minval));');

freq_field=uicontrol('Style','edit',...
    'Position',[.80 .60 .12 .10],...
    'Units','normalized','String',num2str(maxval),...
    'Callback','maxval=str2double(get(freq_field,''String'')); set(freq_field,''String'',num2str(maxval));');
