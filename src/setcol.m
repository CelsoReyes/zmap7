function setcol()
    ...
    b = uicontrol('Parent',a, ...
        'Units','points', ...
        'Callback','C = uisetcolor;cb1 = C(1);cb2=C(2);cb3=C(3);close;mainmap_overview()', ...
        'Position',[53.3793 70.1379 108 21.7241], ...
        'String','Graph Background', ...
        'Tag','Pushbutton1');
    b = uicontrol('Parent',a, ...
        'Units','points', ...
        'Callback','C = uisetcolor;c1 = C(1);c2=C(2);c3=C(3);close;whitebg([c1 c2 c3]);mainmap_overview()', ...
