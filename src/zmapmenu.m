function zmapmenu() % autogenerated function wrapper
    %  zmapmenu allows the user to setup parameters for zmaps
    %
    ...
    function callbackfun_007(mysrc,myevt)
        ...
        callback_tracker(mysrc,myevt,mfilename('fullpath'));
        ZG.compare_window_yrs = 0.1;
        show_map('ast',in2, ZG.compare_window_yrs);
    end
    ...
    function callbackfun_008(mysrc,myevt)
        ...
        callback_tracker(mysrc,myevt,mfilename('fullpath'));
        ZG.compare_window_yrs = 0.1;
        show_map('per',in2,ZG.compare_window_yrs);
    end
