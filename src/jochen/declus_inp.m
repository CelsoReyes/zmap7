function [out,nMethod] = declus_inp(catalog, varargin)
    ...
    methoddescriptions={'Gardner & Knopoff (1974)| Gruenthal (pers. comm.)| Uhrhammer (1986)'};
    ...
    uicontrol('Style','Pushbutton','String','Plot',...
        'Position',[.3 .35 .2 .1 ],...
        'Units','normalized','Callback',@(~,~)plot_cluster_win(catalog));
    ...
    guicontrol('Style','Pushbutton','String','Go',...
        'Position',[.8 .6 .20 .095],...
        'Units','normalized',...
        'Callback',@cb_go);
