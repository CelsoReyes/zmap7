function [mMaxRadCatalog] = ex_CheckMaxRadius(mCatalog, mPolygon, nNode, caNodeIndices, fMaxRadius, nNumberEvents, bMap)
    % check an earthquake catalog for one grid node on a given number and a maximum radius
    %
    % [mMaxRadCatalog] = ex_CheckMaxRadius(mCatalog, mPolygon, nNode, caNodeIndices, fMaxRadius, nNumberEvents, bMap);
    % --------------------------------------------------------------------------------------------------------------------
    %
