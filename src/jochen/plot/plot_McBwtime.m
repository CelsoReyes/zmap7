function plot_McBwtime(catalog, sPar) % autogenerated function wrapper
    ...
    %[labelList2] = McMethods.dropdownList();
    
    zdlg = ZmapDialog();
    zdlg.AddBasicPopup('nMethod',   'Mc Calculation Method',    McMethods.dropdownList(), double(inpr1), 'Define how the Magnitude of Completeness is caluclated');
    zdlg.AddBasicEdit('nSampleSize', 'Sample window size',      nSampleSize,    'number of events in each window');
    zdlg.AddBasicEdit('minEventCount', 'Min. # of events',      minEventCount,  'minimum number of events in order to calc. window');
    zdlg.AddBasicEdit('nOverlap',   'Window overlap', nOverlap,      'Samplesize/nOverlap determines overlap of moving windows');
    zdlg.AddBasicEdit('nBstSample', 'Bootstraps',               nBstSample,     'Number of samples in bootstrap(?)');
    zdlg.AddBasicEdit('fMcCorr',    'Mc correction',            fMcCorr,        'correction for the magnitude of completeness');
    zdlg.AddBasicEdit('fBinning',   'Magnitude Binning',        fBinning,       'size of magnitude bins');
    zdlg.AddBasicEdit('windowSize','Smooth plot',              nWindowSize,    'smooth plot');
