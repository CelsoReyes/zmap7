function clusterdeg(mCatalog, vCluster)
    ...
    if ~exist(vCluster,'var') || isempty(vCluster) || isempty(mCatalog.Longitude)
        errordlg('No declustered catalog available.','Error');
        return
    end
    ...
    hd1_clusterdeg_fig=figure_w_normalized_uicontrolunits('tag','fig_clusdeg',...
        'Name','Degree of Clustering',...
        'Units','normalized',...
        'Nextplot','add',...
        'Numbertitle','off');
