function [fXGridNode, fYGridNode, nNodeGridPoint] = calc_ClosestGridNode(mPolygon, fX, fY)
    % determine closest grid point to a point picked on a map with a defined polygon
    % [fXGridNode, fYGridNode, nNodeGridPoint] = calc_ClosestGridNode(mPolygon, fX, fY);
    % -------------------------------------------------------------------------------------------
    % determine closest grid point to a point picked on a map with a defined polygon
