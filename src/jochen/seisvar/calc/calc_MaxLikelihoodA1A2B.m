function [fBValue, fA1Value, fA2Value] = calc_MaxLikelihoodAB(mCatalog, mControl, bReBin)
...
%   fA2Value         Maximum likelihooda-value
%   fA2Value         Maximum likelihooda-value
% Danijel Schorlemmer
% July 5, 2002
...
[vValues, vDummy, bExitFlag_] = fminsearch('callback_LogLikelihoodA1A2BValue', vStartValues, [], caCatalogs_, mControl);
% Return values
fA1Value = vValues(1);
fBValue  = vValues(2);
fA2Value = vValues(3);
