...
go_button=uicontrol('Style','Pushbutton',...
    ...
    'Units','normalized',...
    'Callback','fix2=str2num(inp3_field.String);fix1=str2num(inp2_field.String);zmap_message_center();axes(h1);caxis([fix1 fix2]);hold off; h5 = colorbar(''vert'') ;set(h5,''Pos'',[apo(1)+apo(3)+0.05 apo(2) 0.03 apo(4)],''FontWeight'',''bold'',''FontSize'',ZmapGlobal.Data.fontsz.m);watchoff',...
    'String','Go');

freeze_button = uicontrol(...
    'BackgroundColor',[ 0.7 0.7 0.7 ],...
    'Callback','fre=freeze_button.Value;',...
