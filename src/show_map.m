function show_map(in, in2, ZG.compare_window_yrs) % autogenerated function wrapper
    ...
    if in2 ~= 'calma'
        ...
        if it + ZG.compare_window_yrs > teb || it < t0b
        ...
        % initial parameter
        winlen_days = floor(ZG.compare_window_yrs* 365/ZG.bin_days); ti = floor((it -t0b)/days(ZG.bin_days));
    ...
    function callbackfun_002(mysrc,myevt)
        ...
        callback_tracker(mysrc,myevt,mfilename('fullpath'));
        ZG.compare_window_yrs=str2double(inp3_field.String);
