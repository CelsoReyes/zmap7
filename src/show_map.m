function show_map(in, in2, compare_window_yrs) % autogenerated function wrapper
    ...
    %TOFIX (maybe) changing compare_window_yrs doesn't change the global version.
    ...
    if in2 ~= 'calma'
        ...
        if in == 'rub' || in == 'lta'
            ...
            inp3_field=uicontrol('Style','edit',...
                ...
                'Units','normalized','String',num2str(compare_window_yrs),...
        ...
        if it + compare_window_yrs > teb || it < t0b
        ...
        % initial parameter
        winlen_days = floor(compare_window_yrs* 365/ZG.bin_days); ti = floor((it -t0b)/days(ZG.bin_days));
    ...
    function callbackfun_002(mysrc,myevt)
        ...
        callback_tracker(mysrc,myevt,mfilename('fullpath'));
        compare_window_yrs=str2double(inp3_field.String);
        inp3_field.String=num2str(compare_window_yrs);
    end
