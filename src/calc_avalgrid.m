...
if sel == 'in'
    ...
    freq_field1=uicontrol('Style','edit',...
        ...
        'Callback','ri=str2double(freq_field1.String); freq_field1.String=num2str(ri); tgl2.Value=1; tgl1.Value=0;');
    ...
    freq_field4=uicontrol('Style','edit',...
        ...
        'Callback','fFixbValue=str2double(freq_field3.String); freq_field3.String=num2str(fFixbValue);');
    ...
    create_grid =  uicontrol('Style','radiobutton',...
        'string','Calculate a new grid', 'Callback','load_grid.Value=0; prev_grid.Value=0;','Position',[.55 .55 .2 .080],...
        'Units','normalized');

    set(create_grid,'value',1);

    prev_grid =  uicontrol('Style','radiobutton',...
        'string','Reuse the previous grid', 'Callback','load_grid.Value=0;create_grid.Value=0;','Position',[.55 .45 .2 .080],...
        'Units','normalized');


    load_grid =  uicontrol('Style','radiobutton',...
        'string','Load a previously saved grid', 'Callback','prev_grid.Value=0;create_grid.Value=0;','Position',[.55 .35 .2 .080],...
        'Units','normalized');
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback',' inb1=hndl2.Value;tgl1=tgl1.Value;tgl2=tgl2.Value;prev_grid=prev_grid.Value;create_grid=create_grid.Value; load_grid=load_grid.Value; save_grid=save_grid.Value; oldfig_button=oldfig_button.Value; close,sel =''ca'', calc_avalgrid',...
        'String','Go');
