...
function orig_inmakegr(catalog) % autogenerated function wrapper
    ...
    zdlg = ZmapDialog([]);
    zdlg.AddEventSelectionParameters('evsel',ni,[],[]);
    zdlg.AddGridParameters('grid',dx,'deg',dy,'deg',[],[]);
    zdlg.AddBasicEdit('ts_days', 'Time step in days:', ZG.bin_dur,'time step in days');
