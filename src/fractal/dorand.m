function dorand() % autogenerated function wrapper
%
...
switch(butto)
    ...
    case 'button'
        ...
        uicontrol('Units','normal','Position',[.0 .94 .2 .06],...
            'String','Fractal Dimension', 'callback',@callbackfun_001);

        uicontrol('Units','normal','Position',[.2 .94 .2 .06],...
            'String','Change Catalog', 'callback',@callbackfun_002);

        uicontrol('Units','normal','Position',[.4 .94 .2 .06],...
            'String','Keep as Catalog', 'callback',@callbackfun_003);
