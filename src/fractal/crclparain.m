...
input4 = uicontrol('Style','edit','Position',[.75 .34 .10 .09],...
    ...
    'Value',1,'Callback','ra=str2double(get(input4,''String'')); set(input4,''String'', num2str(ra));');
...
tx6 = text('EraseMode','normal', 'Position',[0 .34 0], 'Rotation',0 ,...
    'FontSize',fontsz.m , 'FontWeight','bold' , 'String','Radius of the sampling sphere:', 'color', 'w');
