...
%{
        ...
        function create_figure(obj)
            ...
            figure_w_normalized_uicontrolunits( ...
                ...
                ...'Visible','off', ...
                'Tag','cum',...
                'Position',position_in_current_monitor(ZG.map_len(1)-10, ZG.map_len(2)-20));
        ...
        function create_menu(obj)
            ...
            uimenu(catmenu,'Label','Rename Catalog (this subset)',...
                Futures.MenuSelectedFcn,@cb_rename_cat);
            
            uimenu(catmenu,'Label','Set as main catalog',...
                Futures.MenuSelectedFcn,@cb_keep); % Replaces the primary catalog, and replots this subset in the map window
            ...
            uimenu(op3D,'Label','Time-depth plot ',...
                Futures.MenuSelectedFcn,@(~,~)TimeDepthPlotter.plot(ZG.Views.timeplot));
            uimenu(op3D,'Label','Time-magnitude plot ',...
                Futures.MenuSelectedFcn,@(~,~)TimeMagnitudePlotter.plot(ZG.Views.timeplot));
            ...
            uimenu(op4B, 'Label', 'beta values: LTA(t) function',...
                Futures.MenuSelectedFcn,{@cb_z_beta_ratechanges,'bet'});
            uimenu(op4B, 'Label', 'beta values: "Triangle" Plot',...
                Futures.MenuSelectedFcn, {@cb_betaTriangle,'newcat'})
            uimenu(op4B,'Label','z-values: AS(t)function',...
                Futures.MenuSelectedFcn,{@cb_z_beta_ratechanges,'ast'})
            uimenu(op4B,'Label','z-values: Rubberband function',...
                Futures.MenuSelectedFcn,{@cb_z_beta_ratechanges,'rub'})
            uimenu(op4B,'Label','z-values: LTA(t) function ',...
                Futures.MenuSelectedFcn,{@cb_z_beta_ratechanges,'lta'});
            ...
            uimenu(op4,'Label','b with depth',Futures.MenuSelectedFcn,@(~,~)bwithde2())
            ...
            uimenu(op5,'Label','Define mainshock',...
                'Enable','off', Futures.MenuSelectedFcn,@cb_016);
            ...
            uimenu(ztoolsmenu,'Label','Cumulative Moment Release ',Futures.MenuSelectedFcn,@(~,~)morel(ZG.Views.timeplot))
            ...
            uimenu(op5C,'Label','Magnitude',...
                Futures.MenuSelectedFcn,@(~,~)obj.histogram('Magnitude'));
            uimenu(op5C,'Label','Depth',...
                Futures.MenuSelectedFcn,{@cb_histogram,'Depth'});
            uimenu(op5C,'Label','Time',...
                Futures.MenuSelectedFcn,{@cb_histogram,'Date'});
            uimenu(op5C,'Label','Hr of the day',...
                Futures.MenuSelectedFcn,{@cb_histogram,'Hour'});
            
            
            %uimenu(ztoolsmenu,'Label','Save cumulative number curve',...
            %    'Separator','on',...
            %    Futures.MenuSelectedFcn,@(~,~)errordlg('unimplemented','unimplemented');
