...
switch (bc)
    ...
    case 'new'
        ...
        set(h5,'visible','on','FontSize',fontsz.s,'FontWeight','normal',...
        ...
        ha1 = uicontrol('Style', 'pushbutton', 'String', ' Projection Control dialog box',...
            'Position', [0.02 0.03 0.23 .04],'Units','Normalized','Callback', 'scaleruler off;axesmui;bc='' '';overmaptb');
        ...
        ha9= uicontrol('Style', 'pushbutton', 'String', ' Black/White',...
            'Position', [0.7 0.08 0.10 .03],'Units','Normalized','Callback','bc = ''bw''; overmaptb');
