function ctimeplot() % autogenerated function wrapper
    ...
    function create_my_menu()
        ...
        uimenu(options,'Label','Cuts in magnitude and depth','MenuSelectedFcn',@callbackfun_001)
        uimenu (options,'Label','Decluster the catalog','MenuSelectedFcn',@(~,~)inpudenew());
        uimenu(options,'Label','AS(t)function','MenuSelectedFcn',@(~,~)newsta('ast'));
        uimenu(options,'Label','Rubberband function','MenuSelectedFcn',@(~,~)newsta('rub'));
        uimenu(options,'Label','LTA(t) function ','MenuSelectedFcn',@(~,~)newsta('lta'));
        uimenu(options,'Label','Overlay another curve (hold)','MenuSelectedFcn',@callbackfun_002)
        ...
        uimenu(op5,'Label','manual','MenuSelectedFcn',@callbackfun_003)
        uimenu(op5,'Label','automatic','MenuSelectedFcn',@callbackfun_004)
        uimenu(options,'Label','get coordinates with Cursor','MenuSelectedFcn',@callbackfun_005)
        uimenu(options,'Label','Cumlative Moment Release ','MenuSelectedFcn',@callbackfun_006)
        uimenu(options,'Label','Time Selection','MenuSelectedFcn',@callbackfun_007);
        %uimenu(options,'Label',' Magnitude signature','MenuSelectedFcn',@callbackfun_008)
        uimenu(options,'Label','Save cumulative number curve','MenuSelectedFcn',@callbackfun_009)
        calSave =...
