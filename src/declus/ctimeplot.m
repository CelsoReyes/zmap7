function ctimeplot() % autogenerated function wrapper
    ...
    if isempty(cum)
        ...
        winlen_days = ZG.compare_window_yrs/days(ZG.bin_days);
        create_my_menu();
    ...
    if ZG.bin_days >=1
        ...
        [cumu, xt] = hist((ZG.newt2.Date-ZG.newt2.Date(1)+days(ZG.bin_days))*365,(0:ZG.bin_days:(tdiff+2*ZG.bin_days)));
    end
    cumu2=cumsum(cumu);
    ZG.bin_days
    % plot time series
    ...
    if ZG.bin_days>=1
        ...
        statime=ZG.newt2.Date(1)-days(ZG.bin_days);
    ...
    ZG.bin_days = par2; assert(isa(par2,'datetime'));
    done
