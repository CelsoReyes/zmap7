function ctimeplot() % autogenerated function wrapper
    ...
    function create_my_menu()
        ...
        uimenu(options,'Label','Cuts in magnitude and depth',MenuSelectedFcnName(),@cb_cut_mag_depth)
        ...
        uimenu(options,'Label','Overlay another curve (hold)',MenuSelectedFcnName(),@cb_overlayanothercurve)
        ...
        uimenu(op5,'Label','manual',MenuSelectedFcnName(),@cb_man_pval_estimation)
        uimenu(op5,'Label','automatic',MenuSelectedFcnName(),@cb_auto_pval_estimation)
        uimenu(options,'Label','get coordinates with Cursor',MenuSelectedFcnName(),@cb_getcoord_with_cursor)
        uimenu(options,'Label','Cumlative Moment Release ',MenuSelectedFcnName(),@cb_cum_moment_release)
        uimenu(options,'Label','Time Selection',MenuSelectedFcnName(),@cb_time_selection);
        %uimenu(options,'Label',' Magnitude signature',MenuSelectedFcnName(),@cb_mag_signature)
        uimenu(options,'Label','Save cumulative number curve',MenuSelectedFcnName(),@cb_save_cumnumcurve)
        calSave =...
