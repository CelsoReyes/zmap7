function ctimeplot() % autogenerated function wrapper
    ...
    function create_my_menu()
        ...
        uimenu(op4,'Label','b with depth', 'Callback',@(~,~)bwithde(ZG.newt2))
        uimenu(op4,'Label','b with time', 'Callback',@(~,~)bwithti(ZG.newt2))
    ...
    function callbackfun_001(mysrc,myevt)
        ...
        ZG=ZmapGlobal.Data;
        [ZG.newt2,ZG.maepi,ZG.big_eq_minmag]=catalog_overview(ZmapCatalogView('newt2'),ZG.big_eq_minmag);
    end
