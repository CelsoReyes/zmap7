...
if sel == 'in'
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback',' inb1 =get(hndl2,''Value'');tgl1 =get(tgl1,''Value'');tgl2 =get(tgl2,''Value'');close,sel =''ca'', bvalgridbig',...
        'String','Go');
...
if sel == 'ca'
    ...
    for i= 1:length(newgri(:,1))
        ...
        if mr < rd+lp*1.1
            ...
            l = sqrt(((b2(:,1)-x)*cos(pi/180*y)*111).^2 + ((b2(:,2)-y)*111).^2) ;
            [s,is] = sort(l);
            b = b2(is(:,1),:) ;       % re-orders matrix to agree row-wise
        end
        ...
        bvg = [bvg ; bv magco x y rd bv2 stan2 av stan prf];
