...
if sel == 'in'
    ...
    def = {t1,t2,t3,t4}
    title2 ='Differntial b-value map ';
    prompt={'T1 = ', 'T2= ', 'T3 = ', 'T4= '};

    ni2 = inputdlg(prompt,title2,1,def);
    l = ni2{4};
    t4 = str2double(l);
    l = ni2{3};
    t3 = str2double(l);
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1 =get(hndl1,''Value'');inb2 =get(hndl2,''Value'');close,sel =''ca'', btmp',...
        'String','Go');
...
[x,y, mouse_points_overlay] = select_polygon(ax);
    ...
    for i= 1:length(newgri(:,1))
        ...
        if length(b(:,1)) >= 150;
            ...
            if pr >=99
                bvg = [bvg ; bv magco x y length(b(:,1)) bv2 pr av stan  max(b(:,6)) bv-bv2  pr];
            else
                bvg = [bvg ; 0 NaN x y 0 0 0 0 0  0 0 0 ];
            end
        else
            bvg = [bvg ; NaN NaN x y NaN NaN NaN NaN NaN  NaN NaN NaN ];
        end
