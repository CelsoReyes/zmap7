function predi_ca() 
    ...
    elseif isnan(Mc90) == 0
        ...
        [bv magco stan av pr] =  bvalca3(obs.Magnitude,McAutoEstimate.auto);
    end
    magco = magco+0;
    l = obs.Magnitude >= magco-0.05;
    nEvents=sum(l);
    
    %[bv magco0 stan av pr] =  bvalca3(obs.Magnitude(l), McAutoEstimate.manual);
    [bv4 stan4 ] = calc_bmemag(obs.Magnitude(l), 0.1);
