function create_all_menus(obj, force)
    ...
    function create_map_analysis_menu()
        ...
        %uimenu(submenu, 'Label', 'Map stress tensor', MenuSelectedField(), @(~,~)stressgrid());
    ...
    function create_overlay_menu()
        ...
        uimenu(mapoptionmenu, 'Label', 'Change Z aspect ratio',...
            MenuSelectedField(), @obj.set_z_ratio); % callback was plot3d
