...
if sel == 'in'
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1 =get(hndl2,''Value'');tgl1 =get(tgl1,''Value'');tgl2 =get(tgl2,''Value'');close,sel =''ca'', btimex',...
        'String','Go');
...
if sel == 'ca'
    ...
    dasp = get(gca,'dataaspect');
    figure
    plot(newa(:,11), dasp(1)*(newa(:,3)-min(newa(:,3))),'+');
    axis image
...
[x,y, mouse_points_overlay] = select_polygon(ax);
    ...
    %
    xsecy = dasp(1) * (newa(:,3)-min(newa(:,3)));
