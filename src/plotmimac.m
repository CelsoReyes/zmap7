function plotmimac() % autogenerated function wrapper
    ...
    %var1 = 4;
    sc = get(hndl3,'Value');
    figure(hndl3) % TOFIX: really? this figure? unsure
    ...
    mic = mi(inde,:);
    le = length(newa(1,:)); %TOFIX where does newa come from? ZG.newa? input parameter?  Needs to be treated like a ZmapCatalog
