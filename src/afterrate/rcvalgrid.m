function rcvalgrid() % autogenerated function wrapper
% Scrip: rcvalgrid.m
...
if sel == 'in'
    ...
    tgl1 = uicontrol('Style','radiobutton',...
        ...
        'Position',[.05 .60 .2 .0800], 'callback',@callbackfun_012,...
        'Units','normalized');
    ...
    tgl2 =  uicontrol('Style','radiobutton',...
        ...
        'Position',[.05 .50 .2 .080], 'callback',@callbackfun_013,...
        'Units','normalized');
    set(tgl2,'value',1);

    create_grid =  uicontrol('Style','radiobutton',...
        'string','Calculate a new grid', 'callback',@callbackfun_014,'Position',[.78 .55 .2 .080],...
        'Units','normalized');

    set(create_grid,'value',1);

    prev_grid =  uicontrol('Style','radiobutton',...
        'string','Reuse the previous grid', 'callback',@callbackfun_015,'Position',[.78 .45 .2 .080],...
        'Units','normalized');


    load_grid =  uicontrol('Style','radiobutton',...
        'string','Load a previously saved grid', 'callback',@callbackfun_016,'Position',[.78 .35 .2 .080],...
        'Units','normalized');
    ...
    close_button=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized','callback',@callbackfun_017,'String','Cancel');
