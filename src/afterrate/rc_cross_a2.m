function rc_cross_a2(sel)
    ...
    if sel == 'ca'
        ...
        save rcval_grid.mat mRcCross gx gy dx dy ZG.bin_days tdiff t0b teb a main faults mainfault coastline yvect xvect tmpgri ll bo1 newgri ra time timef bootloops ZG.maepi xsecx xsecy
        ...
        %             ' sapa2 = [''save '' path1 file1 '' mRcCross gx gy dx dy ZG.bin_days tdiff t0b teb a main faults mainfault coastline yvect xvect tmpgri ll bo1 newgri gll''];',...
