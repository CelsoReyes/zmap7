...
if sel == 'ca'
    ...
    save rcval_grid.mat mRcCross gx gy dx dy par1 tdiff t0b teb a main faults mainfault coastline yvect xvect tmpgri ll bo1 newgri ra time timef bootloops ZG.maepi xsecx xsecy
