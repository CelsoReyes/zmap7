function newsta(sta)
   ...
   delete(findobj(cumfig,'Tag','cumulativeplot'));
    ...
    function probValues=translating(catalog, values, value2trans) % autogenerated function wrapper
        % translating
        % turned into function by Celso G Reyes 2017
    ...
    function isFitted=sim_2prob(value2trans, BigCatalog,BetaValues) % autogenerated function wrapper
        % needed variables
