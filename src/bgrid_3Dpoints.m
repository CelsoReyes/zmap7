...
if sel == 'i1'
    ...
    go_button1=uicontrol('Style','Pushbutton',...
        ...
        'Units','normalized',...
        'Callback','inb1 =get(hndl2,''Value'');tgl1 =get(tgl1,''Value'');tgl2 =get(tgl2,''Value'');close,sel =''in'', bgrid_3Dpoints',...
        'String','Go');
...
if sel == 'in'
    ...
    def = {'2',num2str(max(a(:,7))), num2str(min(a(:,7)))};

    tit ='Three dimesional b-value analysis - at each hypocenter';
    prompt={ 'random factor >=1',...
        'Depth range: deep limit [km] ',...
        'Depth range: shallow limit',...
        };

    ni2 = inputdlg(prompt,tit,1,def);
    l = ni2{1}; raf= str2double(l);
    l = ni2{2}; z1= str2double(l);
    l = ni2{3}; z2= str2double(l);


    sel = 'ca'; bgrid_3Dpoints
...
if sel == 'pl'
    ...
    l = bvg(:,1)<  1.;
    scatter3(bvg(l,3),bvg(l,4),-bvg(l,5),10,bvg(l,1),'filled');
    box on
    hold on
