function ezlabels(command)
    %
    %   GUI input for labels and titles
    %
    %   typing 'ezlabels' from the command line opens an
    %   interactive dialogue box, allowing the user to specify
    %   axes labels and the figure title as well as the Font, Size, Weight
    ...
    %
    if nargin < 1
        siblines(4)=get(gca,'Title');
        siblines(3)=get(gca,'Xlabel');
        siblines(2)=get(gca,'Ylabel');
        siblines(1)=get(gca,'Zlabel');
        %
        haold=gcf;
        T1=['Avant Garde           ';...
            'Bookman               ';...
        ...
        uicontrol('Parent',leginp,...
            ...
            'string','Xlabel',...
            'units','normalized',...
            'position',[.4 ((Y(3)+.1)/1.2)+.1*sfactor .2 .07*sfactor],...
            'BackgroundColor',[ 0 0 0 ],...
            'ForegroundColor',[ 0 1 0 ]);
        ...
        uicontrol('Parent',leginp,...
            ...
            'string','Ylabel',...
            'units','normalized',...
            'position',[.4 ((Y(2)+.1)/1.2)+.1*sfactor .2 .07*sfactor],...
            'BackgroundColor',[ 0 0 0 ],...
            'ForegroundColor',[ 0 1 0 ]);
        uicontrol('Parent',leginp,...
            'style','text',...
            'string','Zlabel',...
            'units','normalized',...
            'position',[.4 ((Y(1)+.1)/1.2)+.1*sfactor .2 .07*sfactor],...
            'BackgroundColor',[ 0 0 0 ],...
            'ForegroundColor',[ 0 1 0 ]);
