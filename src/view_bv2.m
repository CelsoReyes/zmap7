function view_bv2() % autogenerated function wrapper
    ...
    function create_my_menu()
        ...
        uimenu(options,'Label','Select Eqs in Polygon - new',...
            MenuSelectedFcnName(),{@cb_selectPoly,false});
        uimenu(options,'Label','Select Eqs in Polygon - hold',...
            MenuSelectedFcnName(),{@cb_selectPoly,true});
        ...
        uimenu(op1,'Label','Save map to ASCII file ',MenuSelectedFcnName(),@callbackfun_021)
