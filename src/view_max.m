function view_max(re3,gx,gy,stri,myselector) % autogenerated function wrapper
...
%                 Double click on text allows editing it.   
    ...
    title([name ' (' myselector '); ' num2str(t0b) ' to ' num2str(teb) ' - cut at ' num2str(it) '; winlen_days = ' num2str(ZG.compare_window_yrs) ' yr'],'FontSize',ZmapGlobal.Data.fontsz.m,...
    ...
    function callbackfun_009(mysrc,myevt)
        ...
        ZG.freeze_colorbar = false;
        re3 = old;
        view_max(re3,gx,gy,stri,myselector);
    end
    ...
    function callbackfun_023(mysrc,myevt)
        ...
        pause(1);
        re4 =re3;
        view_maxview_max(re3,gx,gy,myselector);
    end
