...
%                 Double click on text allows editing it.   
    ...
    function create_my_menu()
        ...
        uimenu(op1,'Label','ZMAP Menu',MenuSelectedFcnName(),@callbackfun_004)
        uimenu(op1,'Label','Plot Map in Lambert projection',MenuSelectedFcnName(),@callbackfun_005)
        uimenu(op1,'Label','Fix color (z) scale',MenuSelectedFcnName(),@callbackfun_006)
        uimenu(op1,'Label','Histogram of z-values',MenuSelectedFcnName(),@(~,~)zhist())
        uimenu(op1,'Label','Probability Map',MenuSelectedFcnName(),@callbackfun_008)
        uimenu(op1,'Label','Back to z-value Map',MenuSelectedFcnName(),@callbackfun_009)
        uimenu(op1,'Label','Colormap InvertGray',MenuSelectedFcnName(),@callbackfun_010)
        uimenu(op1,'Label','Colormap Invertjet',...
            MenuSelectedFcnName(),@callbackfun_011)
        
        uimenu(op1,'Label','Resolution Map',MenuSelectedFcnName(),@callbackfun_012)
        uimenu(op1,'Label','Show Grid ',...
            MenuSelectedFcnName(),@callbackfun_013)
        uimenu(op1,'Label','Show Circles ',MenuSelectedFcnName(),@callbackfun_014)
        uimenu(op1,'Label','shading flat',MenuSelectedFcnName(),@callbackfun_015)
