function view_max(valueMap,gx,gy,stri,myselector) % autogenerated function wrapper
...
%                 Double click on text allows editing it.   
    ...
    function create_my_menu()
        ...
        uimenu(op1,'Label','ZMAP Menu',Futures.MenuSelectedFcn,@callbackfun_004)
        uimenu(op1,'Label','Plot Map in Lambert projection',Futures.MenuSelectedFcn,@callbackfun_005)
        uimenu(op1,'Label','Fix color (z) scale',Futures.MenuSelectedFcn,@callbackfun_006)
        uimenu(op1,'Label','Histogram of z-values',Futures.MenuSelectedFcn,@(~,~)zhist())
        uimenu(op1,'Label','Probability Map',Futures.MenuSelectedFcn,@callbackfun_008)
        uimenu(op1,'Label','Back to z-value Map',Futures.MenuSelectedFcn,@callbackfun_009)
        uimenu(op1,'Label','Colormap InvertGray',Futures.MenuSelectedFcn,@callbackfun_010)
        uimenu(op1,'Label','Colormap Invertjet',...
            Futures.MenuSelectedFcn,@callbackfun_011)
        
        uimenu(op1,'Label','Resolution Map',Futures.MenuSelectedFcn,@callbackfun_012)
        uimenu(op1,'Label','Show Grid ',...
            Futures.MenuSelectedFcn,@callbackfun_013)
        uimenu(op1,'Label','Show Circles ',Futures.MenuSelectedFcn,@callbackfun_014)
        uimenu(op1,'Label','shading flat',Futures.MenuSelectedFcn,@callbackfun_015)
