...
function cross_stress_orig() % autogenerated function wrapper
    ...
    zdlg.AddBasicHeader('Stress Variance Parameters');
    zdlg.AddBasicPopup('mc_choice', 'stress tensor inversion method:',labelList2,1,...
        'Choose the calculation method for stress tensor inversion');
    zdlg.AddEventSelectionParameters('selOpts', ni, ra);
    zdlg.AddGridParameters('gridOpts',dx,'km',[],[],dd,'km');
    zdlg.AddBasicEdit('fStrike','Strike [deg]',fStrike,'Strike');
    [zparam,okPressed]=zdlg.Create('Stress Variance input parameters');
    if ~okPressed
        return
    end
    ZG.inb2=zparam.mc_choice;
    ZG.inb1=ZG.inb2;
