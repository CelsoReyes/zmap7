...
if in == 'initf'
    ...
    hndl1=uicontrol(...
        ...
        'Position',labelPos,...
        'String',labelList,...
        'Callback','in2=hndl1.Value; loadhypo');
    ...
    inpnu=uicontrol('Style','edit',...
        ...
        'Callback','nu=str2double(inpnu.String); inpnu.String=num2str(nu))';

    h1 = 13;
    inpy1=uicontrol('Style','edit',...
        'Position',[6 h1   1  0.8],...
        'Units','centimeter','String',num2str(y1),...
        'Callback','y1=str2double(inpy1.String); inpy1.String=num2str(y1))';

    inpy2=uicontrol('Style','edit',...
        'Position',[8 h1   1  0.8],...
        'Units','centimeter','String',num2str(y2),...
        'Callback','y2=str2double(inpy2.String); inpy2.String=num2str(y2))';
    ...
    inpmo2=uicontrol('Style','edit',...
        ...
        'Callback','mo2=str2double(inpmo2.String); inpmo2.String=num2str(mo2))';
    ...
    inpda2=uicontrol('Style','edit',...
        ...
        'Callback','da2=str2double(inpda2.String); inpda2.String=num2str(da2))';
    ...
    inphr2=uicontrol('Style','edit',...
        ...
        'Callback','hr2=str2double(inphr2.String); inphr2.String=num2str(hr2))';
    ...
    inpmi2=uicontrol('Style','edit',...
        ...
        'Callback','mi2=str2double(inpmi2.String); inpmi2.String=num2str(mi2))';
    ...
    inpla2=uicontrol('Style','edit',...
        ...
        'Callback','la2=str2double(inpla2.String); inpla2.String=num2str(la2))';
    ...
    inplm2=uicontrol('Style','edit',...
        ...
        'Callback','lm2=str2double(inplm2.String); inplm2.String=num2str(lm2))';
    inplmc=uicontrol('Style','edit',...
        'Position',[10 h4   1.5  0.8],...
        'Units','centimeter','String',num2str(lmc),...
        'Callback','lmc=str2double(inplmc.String); inplmc.String=num2str(lmc))';
    ...
    inplo2=uicontrol('Style','edit',...
        ...
        'Callback','lo2=str2double(inplo2.String); inplo2.String=num2str(lo2))';
    ...
    inpln2=uicontrol('Style','edit',...
        ...
        'Callback','ln2=str2double(inpln2.String); inpln2.String=num2str(ln2))';
    inplnc=uicontrol('Style','edit',...
        'Position',[10 h4   1.5  0.8],...
        'Units','centimeter','String',num2str(lnc),...
        'Callback','lnc=str2double(inplnc.String); inplnc.String=num2str(lnc))';
    ...
    inpde2=uicontrol('Style','edit',...
        ...
        'Callback','de2=str2double(inpde2.String); inpde2.String=num2str(de2))';

    inpdec=uicontrol('Style','edit',...
        'Position',[10 h4   1.5  0.8],...
        'Units','centimeter','String',num2str(cde),...
        'Callback','cde=str2double(inpdec.String); inpdec.String=num2str(cde))';
    ...
    inpma2=uicontrol('Style','edit',...
        ...
        'Callback','ma2=str2double(inpma2.String); inpma2.String=num2str(ma2))';
    inpmac=uicontrol('Style','edit',...
        'Position',[10 h4   1.5  0.8],...
        'Units','centimeter','String',num2str(mac),...
        'Callback','mac=str2double(inpmac.String); inpmac.String=num2str(mac))';
    ...
    inplaC1=uicontrol('Style','edit',...
        ...
        'Callback','no=str2double(get(inplaC1''String'')); set(inplaC1''String'',num2str(no)');
    ...
    inplaC2=uicontrol('Style','edit',...
        ...
        'Callback','we=str2double(get(inplaC2''String'')); set(inplaC2''String'',num2str(we)');
