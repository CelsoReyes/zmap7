function dispma3() % autogenerated function wrapper
    ...
    function show_dialog()
        ...
        dlg=ZmapFunctionDlg([],@(~,~)do_nothing);
        dlg.AddBasicEdit('t1p','Time 1 (T1):', t1p,'enter begin segment 1');
        dlg.AddBasicEdit('t2p','Time 2 (T2):', t2p,'enter end segment 1');
        dlg.AddBasicEdit('t3p','Time 3 (T3):', t3p,'enter begin segment 2');
        dlg.AddBasicEdit('t4p','Time 4 (T4):', t4p,'enter end segment 2');
        dlg.AddBasicCheckbox('usecursor','Use Cursor', false,[],'select with mouse');
