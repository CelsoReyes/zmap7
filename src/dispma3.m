function dispma3(ic) % autogenerated function wrapper
    ...
    if ic == 1 ||| ic == 0
        ...
        freq_field1=uicontrol('Style','edit',...
            ...
            'Units','normalized','String',num2str(t1p(1),8),...
            'callback',@callbackfun_001);
        
        freq_field2=uicontrol('Style','edit',...
            'Position',[.70 .60 .15 .10],...
            'Units','normalized','String',num2str(t2p(1),8),...
            'callback',@callbackfun_002);
        
        freq_field3=uicontrol('Style','edit',...
            'Position',[.70 .45 .15 .10],...
            'Units','normalized','String',num2str(t3p(1),8),...
            'callback',@callbackfun_003);
        
        freq_field4=uicontrol('Style','edit',...
            'Position',[.70 .30 .15 .10],...
            'Units','normalized','String',num2str(t4p(1),8),...
