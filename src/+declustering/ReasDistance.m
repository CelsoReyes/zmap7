function [dist1, dist2] = ReasDistance(i,bgevent,ac,newcat,err,derr)
	...
	%good enough for me (DE)
	%small change from zmap catalog depth a(:,7) to mapseis shortCatalog a(:,3)
