function timcplo(newa,dist_along_strike_km) % autogenerated function wrapper
    ...
    scatter(dist_along_strike_km, newa.Date, mag2dotsize(newa.Magnitude),newa.Magnitude)%,'.b','MarkerSize',ZG.ms6,'Marker','+');
    c=colorbar;
