...
freq_field3=uicontrol('Style','edit',...
    ...
    'Callback','ya0=str2double(get(freq_field3,''String'')); set(freq_field3,''String'',num2str(ya0,6));');

freq_field4=uicontrol('Style','edit',...
    'Position',[.70 .25 .22 .10],...
    'Units','normalized','String',num2str(xa0,6),...
    'Callback','xa0=str2double(get(freq_field4,''String'')); set(freq_field4,''String'',num2str(xa0,6));');
