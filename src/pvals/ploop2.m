...
report_this_filefun(mfilename('fullpath'));
    ...
    if var1==1
        ...
        if pcheck ~=1
            ...
            %The following 5 lines make c-value larger than ts (A).
            %dt=pc-ts;
            %if dt<=0
            %pc=ts+cstep;
            %cstep=cstep*0.9;
            ...
            %The following 4 lines give I think a better value of c (B).
            if pc<0
                pc=0;
                cstep=cstep*0.9;
            end
