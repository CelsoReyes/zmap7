function slicemap() % autogenerated function wrapper
    ...
    function my_newslice()
        ...
        if ~exist('ZG.xsec_width_km', 'var'); ZG.xsec_width_km = 10; end
        [Ax, Ay, inde] = mysectnoplo(ZG.primeCatalog.Latitude',ZG.primeCatalog.Longitude',ZG.primeCatalog.Depth,ZG.xsec_width_km,0,lat1,lat2,lon1,lon2);
        hold on
        %figure
    ...
    function callbackfun_newdep(mysrc,myevt)
        ...
        Z2 = (X2*0 + ds);
        sliceh = interp3(X,Y,Z,zvg,Y2,X2,Z2);
        set(chil(length(chil)),'Cdata',sliceh); %TOFIX I seriously doubt this is written as intended
