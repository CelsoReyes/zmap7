...
if sel == 'in'
    ...
    figure_w_normalized_uicontrolunits(...
        ...
        'units','points',...
        'Visible','on', ...
        'Units','normalized','Position',[ wex+200 wey-200 550 300], ...
        'Color', [0.8 0.8 0.8]);
    axis off
    ...
    tgl1 = uicontrol('BackGroundColor', [0.8 0.8 0.8], ...
        ...
        'FontSize',fontsz.m ,...
        'FontWeight','bold',...
        'Units','normalized','Position',[.02 .6 .28 .10], 'Callback','set(tgl2,''value'',0)');
    ...
    tgl2 =  uicontrol('BackGroundColor',[0.8 0.8 0.8],'Style','radiobutton',...
        ...
        'FontSize',fontsz.m ,...
        'FontWeight','bold',...
        'Units','normalized','Position',[.52 .60 .28 .10], 'Callback','set(tgl1,''value'',0)');
    ...
    chKBst_button = uicontrol('BackGroundColor', [0.8 0.8 0.8],'Style','checkbox',...
        'FontSize',fontsz.m ,'FontWeight','bold','string','Bootstraps:',...
    ...
    freq_field5 =  uicontrol('Style','edit',...
        ...
        'FontSize',fontsz.m ,...
        'Callback','nBstSample=str2double(get(freq_field5,''String'')); set(freq_field5,''String'',num2str(nBstSample));');

    freq_field6 =  uicontrol('Style','edit',...
        'Units','normalized','Position',[.80 .40 .12 .10],...
        'String',num2str(fMccorr),...
        'FontSize',fontsz.m ,...
        'Callback','fMccorr=str2double(get(freq_field6,''String'')); set(freq_field6,''String'',num2str(fMccorr));');

    freq_field7 =  uicontrol('Style','edit',...
        'Units','normalized','Position',[.30 .50 .12 .10],...
        'String',num2str(fMcFix),...
        'FontSize',fontsz.m ,...
        'Callback','fMcFix=str2double(get(freq_field7,''String'')); set(freq_field7,''String'',num2str(fMcFix));');

    freq_field8 =  uicontrol('Style','edit',...
        'Units','normalized','Position',[.80 .50 .12 .10],...
        'String',num2str(fBinning),...
        'FontSize',fontsz.m ,...
        'Callback','fBinning=str2double(get(freq_field8,''String'')); set(freq_field8,''String'',num2str(fBinning));');
    ...
    text('Color',[0 0 0], 'EraseMode','normal', 'Units', 'normalized', ...
        ...
        'FontSize',fontsz.m, 'FontWeight', 'bold', 'String','Fixed Mc:');
    ...
    text('Color', [0 0 0], 'EraseMode', 'normal', 'Units', 'normalized', ...
        ...
        'FontSize',fontsz.m, 'FontWeight', 'bold', 'String', 'Mc correction:');


    text('Color', [0 0 0], 'EraseMode', 'normal', 'Units', 'normalized', ...
        'Position', [0.52 0.535 0], 'Rotation', 0, 'HorizontalAlignment', 'left', ...
        'FontSize',fontsz.m, 'FontWeight', 'bold', 'String', 'Magnitude binning:');
