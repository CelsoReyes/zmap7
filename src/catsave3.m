    ...
    switch version
        ...
        case 'calc_Omoricross'
            savestuff=[ 'ZmapMessageCenter.set_info(''Save Grid'',''  '');',...
                ...
                ' sapa2 = [''save '' path1 file1 '' mCross gx gy dx dy ZG.bin_dur tdiff t0b teb newa a main faults mainfault coastline yvect xvect tmpgri ll ZG.bo1 newgri ra time timef bootloops ZG.maepi xsecx xsecy ZG.xsec_defaults.WidthKm lon1 lat1 lon2 lat2 ''];',...
                ' if length(file1) > 1, eval(sapa2),end , '];
